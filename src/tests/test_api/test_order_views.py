...
def test_order_list_view(authenticated_client, user, products) -> None:
...
def test_user_order_create(user, authenticated_client, products) -> None:

    data = {"manifest": "%s" % words(12), "number_of_items": 1}
